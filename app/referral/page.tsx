...
function Badge({
  ...
  const cls =
    tone === "indigo"
      ...
      : "border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 text-slate-700 dark:text-slate-300";
    ...
    <section className="rounded-[24px] border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 shadow-[0_18px_55px_rgba(2,6,23,.08)]">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          {desc ? <div className="mt-1 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">{desc}</div> : null}
        </div>
      </div>
    ...
    <div className="rounded-[22px] border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4">
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4">
          ...
          <div className="mt-3 rounded-2xl border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4">
...
function Node({
  ...
  return (
    <div className={`min-w-[140px] rounded-2xl border px-3 py-2 ${cls}`}>
      ...
      {sub ? <div className="mt-1 text-[11px] text-slate-600 dark:text-slate-400">{sub}</div> : null}
    </div>
  );
}
    ...
    <main className="min-h-screen text-slate-900 dark:text-white">
      ...
      <div className="mx-auto max-w-[980px] px-4 py-10">
        ...
        <div className="mb-6 flex items-center justify-between gap-3">
          <Link
            href="/"
            className="text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white underline decoration-slate-200 hover:decoration-slate-400"
          >
            ← トップへ戻る
          </Link>
          <Link
        ...
        <div className="rounded-[28px] border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-6 shadow-[0_30px_90px_rgba(2,6,23,.10)]">
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            ...
            <div className="grid gap-2 md:min-w-[260px]">
              ...
              <Link
                href="/login"
                className="inline-flex items-center justify-center rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900 dark:bg-gray-800 px-4 py-3 text-sm font-semibold text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-gray-800"
              >
                ログイン
              </Link>
            </div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4">
              <div className="text-xs font-extrabold text-slate-700 dark:text-slate-300">初回購入</div>
              <div className="mt-2 text-xl font-extrabold text-slate-900 dark:text-white">最大 20%</div>
              <div className="mt-1 text-xs text-slate-600 dark:text-slate-400">EPで付与（ギフト交換のみ）</div>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4">
              <div className="text-xs font-extrabold text-slate-700 dark:text-slate-300">追加クレジット</div>
              <div className="mt-2 text-xl font-extrabold text-slate-900 dark:text-white">10%</div>
              <div className="mt-1 text-xs text-slate-600 dark:text-slate-400">会員継続中のみ / 月上限まで</div>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4">
              <div className="text-xs font-extrabold text-slate-700 dark:text-slate-300">紹介できる人</div>
              <div className="mt-2 text-xl font-extrabold text-slate-900 dark:text-white">誰でもOK</div>
              <div className="mt-1 text-xs text-slate-600 dark:text-slate-400">EP受取は「紹介者アカウント（無料）」</div>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-2">
            ...
            >
              <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4 text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
                <div className="font-extrabold text-slate-900 dark:text-white">流れ</div>
          ...
          <div className="mt-6">
            ...
            >
              <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                <table className="min-w-[840px] w-full text-sm">
                  ...
                  <tbody>
                    {planRows.map((r) => (
                      <tr key={r.plan} className="border-t border-slate-200 dark:border-gray-700">
                        <td className="px-4 py-3 font-extrabold text-slate-900 dark:text-white">
                          ${r.plan} <span className="ml-2 text-xs font-semibold text-slate-500 dark:text-slate-400">{r.label}</span>
                        </td>
                        <td className="px-4 py-3 text-slate-700 dark:text-slate-300">{r.maxRefPerMonth}</td>
                        <td className="px-4 py-3 text-slate-700 dark:text-slate-300">{r.epCapPerMonth}</td>
                        <td className="px-4 py-3 text-slate-700 dark:text-slate-300">{r.epRateNormal}</td>
                        <td className="px-4 py-3 text-slate-700 dark:text-slate-300">{r.epRateMax}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            >
              <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                <table className="min-w-[760px] w-full text-sm">
                  ...
                  <tbody>
                    {epRows.map((r) => (
                      <tr key={r.amountUsd} className="border-t border-slate-200 dark:border-gray-700">
                        <td className="px-4 py-3 font-extrabold text-slate-900 dark:text-white">${formatUSD(r.amountUsd)}</td>
                        <td className="px-4 py-3 text-slate-700 dark:text-slate-300">${formatUSD(r.first20Usd)} 相当EP</td>
                        <td className="px-4 py-3 text-slate-700 dark:text-slate-300">${formatUSD(r.add10Usd)} 相当EP</td>
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-2">
            ...
            >
              <div className="grid gap-3">
                <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4">
                  <div className="text-sm font-extrabold text-slate-900 dark:text-white">LIFAI（単層）</div>
            ...
            >
              <div className="rounded-2xl border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4 text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
                <p className="font-extrabold text-slate-900 dark:text-white">この紹介制度について</p>
                <p className="mt-2">
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-2">
            ...
            <Link
              href="/rule"
              className="inline-flex items-center justify-center rounded-2xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4 text-sm font-semibold text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-gray-800"
            >
              利用規約を見る
            </Link>
          </div>
