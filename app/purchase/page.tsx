    ...
    <main className="min-h-screen bg-white dark:bg-[#070A12] text-slate-900 dark:text-white">
      {PURCHASE_DISABLED && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm">
          <div className="mx-4 rounded-[28px] border border-slate-200 dark:border-white/10 bg-white dark:bg-gray-900 px-8 py-8 text-center shadow-[0_30px_90px_rgba(2,6,23,.20)] max-w-sm w-full">
            <div className="text-base font-extrabold text-slate-900 dark:text-white">現在このページからの購入は停止中です</div>
            ...
            <Link
              href="/"
              className="mt-6 inline-flex w-full items-center justify-center rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-gray-800 px-4 py-3 text-sm font-semibold text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-gray-700"
            >
              トップへ戻る
            </Link>
          </div>
