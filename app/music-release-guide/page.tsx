...
export default function MusicReleaseGuidePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0a0a0a] text-slate-900 dark:text-white px-4 py-10 max-w-2xl mx-auto">
      ...
      <p className="text-slate-500 dark:text-white/50 text-sm mb-8">LIFAIで生成した楽曲を世界に届ける方法</p>

      {/* Narasu */}
      <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-6 mb-6">
        ...
        <div className="space-y-2 mb-4">
          <h3 className="text-sm font-bold text-slate-700 dark:text-white/80">📋 必要な準備</h3>
          <ul className="text-sm text-slate-600 dark:text-white/60 space-y-1 list-disc list-inside">
            <li>楽曲ファイル（MP3）</li>
        ...
        <div className="space-y-2 mb-4">
          <h3 className="text-sm font-bold text-slate-700 dark:text-white/80">📝 申請手順</h3>
      ...
      <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-6 mb-6">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block w-full py-3 rounded-xl border border-slate-300 dark:border-white/20 text-slate-800 dark:text-white text-center font-bold text-sm"
        >
          TuneCoreで申請する →
        </a>
      </div>
      ...
      <div className="bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-6 mb-8">
        ...
        <ul className="text-sm text-slate-600 dark:text-white/60 space-y-2 list-disc list-inside">
      ...
      <a
        href="/music2"
        className="block text-center text-slate-400 dark:text-white/40 text-sm"
      >
        ← 音楽生成に戻る
      </a>
    </div>
