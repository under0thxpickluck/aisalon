...
const NOTICES: Notice[] = [
  {
    ...
    date: "2026-06-10",
    title: "【紹介報酬のお支払いについて】",
    body: "いつもLIFAIをご利用いただきありがとうございます。\n\n本日予定しておりました紹介報酬の初回払い出しにつきまして、一部システム設定および最終確認作業に時間を要しており、お支払いが本日夜間、または遅くとも明日中となる見込みです。\n\n3月のサービス開始以降、サーバー設備の増強やシステム構築を優先して進めていた影響で、紹介報酬機能の整備にお時間をいただいておりました。\n\nお待たせしてしまい申し訳ございません。\n\n現在は最終確認段階となっており、払い出し自体は予定通り実施いたしますのでご安心ください。\n\n進捗があり次第、改めてお知らせいたします。\n\n今後ともLIFAIをよろしくお願いいたします。",
  },
];
