    ...
    <main id="top" className="min-h-screen bg-neutral-50 dark:bg-gray-900">
      ...
      <section className="mx-auto max-w-5xl px-4 py-12">
        <div className="rounded-2xl bg-white dark:bg-gray-900 p-8 shadow-sm">
          ...
          <div className="mb-4 flex items-center justify-between gap-4">
            <p className="text-xs font-bold text-neutral-500 dark:text-slate-400">LIFAIでできる副業</p>

            {/* ✅ 最初に戻るボタン */}
            <Link
              href="/"
              className="inline-flex items-center gap-2 rounded-full border bg-white dark:bg-gray-800 px-4 py-2 text-xs font-semibold text-neutral-800 dark:text-slate-200 transition hover:bg-neutral-50 dark:hover:bg-gray-700"
            >
              ← 最初に戻る
            </Link>
          </div>
          ...
          {/* 上部ヒーロー画像 */}
          <div className="mb-5 overflow-hidden rounded-xl border bg-neutral-50 dark:bg-gray-800">
      ...
      <section className="mt-10">
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="mt-4 mb-5 overflow-hidden rounded-xl border bg-neutral-50 dark:bg-gray-800">
      ...
      <section className="mx-auto max-w-5xl px-4 pb-12">
        <div className="rounded-2xl bg-white dark:bg-gray-900 p-8 shadow-sm">
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">今できる副業例</h2>
          <p className="mt-3 text-sm leading-7 text-neutral-700 dark:text-slate-300">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {[
              ...
              <Link
                key={item.title}
                href={item.href}
                className="group rounded-xl border bg-neutral-50 dark:bg-gray-800 p-5 transition hover:bg-white dark:hover:bg-gray-700"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-2 text-sm leading-6 text-neutral-700 dark:text-slate-300">{item.desc}</p>
                    <p className="mt-3 inline-flex rounded-full border bg-white px-3 py-1 text-xs font-semibold text-neutral-700 dark:text-slate-300">
                      {item.tag}
                    </p>
                  </div>
                  ...
                  {/* 右：→ */}
                  <div className="shrink-0">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border bg-white text-neutral-700 dark:text-slate-300">
                      →
                    </div>
                  </div>
                </div>
      ...
      <section id="music-flow" className="mx-auto max-w-5xl px-4 pb-12">
        <div className="rounded-2xl bg-white dark:bg-gray-900 p-8 shadow-sm">
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">音楽を作って、配信して、収益にする</h2>
          ...
          <div className="mt-6 rounded-xl border bg-neutral-50 dark:bg-gray-800 p-4">
            ...
            <p className="mt-3 text-xs text-neutral-600 dark:text-slate-400">※ 流れは「作る → 登録 → 配信/BGM → 収益」です。</p>
          </div>

          <div className="mt-7 rounded-xl border bg-neutral-50 dark:bg-gray-800 p-6">
            <h3 className="text-sm font-bold text-neutral-900 dark:text-white">何をするの？（超かんたん5ステップ）</h3>

            <ol className="mt-4 space-y-4 text-sm text-neutral-800 dark:text-slate-200">
              <li>
                <b>① 音楽を作る</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">AIでBGMや音楽を作ります。まずは短い曲でもOKです。</p>
              </li>
              <li>
                <b>② 配信のサービスに登録する</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">TuneCore や narasu などに登録して、曲を出せる状態にします。</p>
              </li>
              <li>
                <b>③ 配信ストアに出る</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">Spotify や Apple Music などで、みんなが聴けるようになります。</p>
              </li>
              <li>
                <b>④ お店や会社のBGMでも使われる</b>
            ...
            <div className="mt-6 rounded-lg bg-white dark:bg-gray-900 p-4">
              <p className="text-sm font-bold text-neutral-900 dark:text-white">この副業のコツ</p>
      ...
      <section id="note-flow" className="mx-auto max-w-5xl px-4 pb-12">
        <div className="rounded-2xl bg-white dark:bg-gray-900 p-8 shadow-sm">
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">noteを自動で作って、積み上げる</h2>
          ...
          <div className="mt-6 rounded-xl border bg-neutral-50 dark:bg-gray-800 p-6">
            <h3 className="text-sm font-bold text-neutral-900 dark:text-white">何をするの？（5ステップ）</h3>

            <ol className="mt-4 space-y-4 text-sm text-neutral-800 dark:text-slate-200">
              <li>
                <b>① テーマを決める</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">日記、体験談、学んだことなど、書くテーマを決めます。</p>
              </li>
              <li>
                <b>② AIで記事を作る</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">テーマを入れるだけで、AIが文章を自動で作ります。</p>
              </li>
              <li>
                <b>③ noteに投稿する</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">作った記事を、そのままnoteに投稿します。</p>
              </li>
              <li>
                <b>④ 読まれる・検索される</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">記事が増えるほど、読まれるチャンスも増えます。</p>
              </li>
              <li>
                <b>⑤ 収益や次の仕事につながる</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">noteの収益や、サービス紹介・別の副業につながります。</p>
              </li>
            </ol>
          </div>

          <div className="mt-6 rounded-lg bg-white dark:bg-gray-900 p-4">
            <p className="text-sm font-bold text-neutral-900 dark:text-white">この副業のポイント</p>
            <ul className="mt-3 space-y-2 text-sm text-neutral-700 dark:text-slate-300">
      ...
      <section id="lp-flow" className="mx-auto max-w-5xl px-4 pb-12">
        <div className="rounded-2xl bg-white dark:bg-gray-900 p-8 shadow-sm">
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">HP・LPを作って、成果につなげる</h2>
          ...
          <div className="mt-6 rounded-xl border bg-neutral-50 dark:bg-gray-800 p-6">
            ...
            <ol className="mt-4 space-y-4 text-sm text-neutral-800 dark:text-slate-200">
              ...
              <li>
                <b>③ 公開する（URLができる）</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">ネット上に公開して、見てもらえる状態にします。</p>
              </li>
              <li>
                <b>④ 反応を見る</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">
          ...
          <div className="mt-6 rounded-lg bg-white dark:bg-gray-900 p-4">
            <p className="text-sm font-bold text-neutral-900 dark:text-white">どうやって収益になる？</p>
            <ul className="mt-3 space-y-2 text-sm text-neutral-700 dark:text-slate-300">
          ...
          <div className="mt-6 rounded-lg border bg-neutral-50 dark:bg-gray-800 p-4">
            <p className="text-sm font-bold text-neutral-900 dark:text-white">初心者が迷わないコツ</p>
            <ul className="mt-3 space-y-2 text-sm text-neutral-700 dark:text-slate-300">
      ...
      <section id="stock-flow" className="mx-auto max-w-5xl px-4 pb-12">
        <div className="rounded-2xl bg-white dark:bg-gray-900 p-8 shadow-sm">
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">写真・画像を作って、ストック販売する</h2>
          ...
          <div className="mt-8 rounded-xl border bg-neutral-50 dark:bg-gray-800 p-6">
            <h3 className="text-sm font-bold text-neutral-900 dark:text-white">何をするの？（5ステップ）</h3>

            <ol className="mt-4 space-y-4 text-sm text-neutral-800 dark:text-slate-200">
              <li>
                <b>① 画像のテーマを決める</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">SNS投稿用、広告用、ブログ用など用途を決めます。</p>
              </li>
              <li>
                <b>② AIやテンプレで画像を作る</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">デザインが苦手でも、AIやテンプレで形にできます。</p>
              </li>
              <li>
                <b>③ ストックサイトに登録</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">画像を登録して、販売できる状態にします。</p>
              </li>
              <li>
                <b>④ 他の人がダウンロード</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">企業や個人が、SNSや広告用に画像を使います。</p>
              </li>
              <li>
                <b>⑤ ダウンロードごとに収益</b>
                <p className="mt-1 text-neutral-600 dark:text-slate-400">使われるたびに、少しずつ収益が入ります。</p>
              </li>
            </ol>
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14">
        <div className="rounded-2xl border bg-white dark:bg-gray-900 dark:border-gray-700 p-8 shadow-sm">
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">もっとLIFAIを知る</h2>
          <p className="mt-3 text-sm leading-7 text-neutral-700 dark:text-slate-300">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <Link
              href="#top"
              className="inline-flex items-center justify-center rounded-xl border bg-white dark:bg-gray-800 px-5 py-3 text-sm font-bold text-neutral-900 dark:text-white transition hover:bg-neutral-50 dark:hover:bg-gray-700"
            >
              ページ上部へ ↑
            </Link>
          </div>
      ...
      <footer className="border-t bg-white dark:bg-gray-900 dark:border-gray-700">
        <div className="mx-auto max-w-5xl px-4 py-6 text-xs text-neutral-500 dark:text-slate-400">
    ...
    <div
      className={`relative flex flex-col rounded-2xl border p-5 ${
        premium
          ...
          : "border-neutral-200 dark:border-gray-700 bg-neutral-50 dark:bg-gray-800"
      }`}
    >
      {recommended && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 whitespace-nowrap">
          <span className="rounded-full bg-amber-400 px-3 py-1 text-xs font-bold text-neutral-900 dark:text-white shadow">
            おすすめ
          </span>
        </div>
      )}
      ...
      <div>
        ...
        <p
          className={`mt-1 text-xs leading-5 ${
            premium ? "text-neutral-400" : "text-neutral-500 dark:text-slate-400"
          }`}
        >
          {catchPhrase}
        </p>
          ...
          <li key={item} className="flex items-start gap-2 text-xs">
            <span
              className={`mt-0.5 shrink-0 font-bold ${
                premium ? "text-neutral-500 dark:text-slate-400" : "text-neutral-400"
              }`}
            >
              ✓
            </span>
            <span className={premium ? "text-neutral-300" : "text-neutral-700 dark:text-slate-300"}>
              {item}
            </span>
          </li>
        ))}
      ...
      <div
        className={`mt-4 border-t pt-3 text-xs font-semibold ${
          premium
            ...
            : "border-neutral-200 dark:border-gray-700 text-neutral-500 dark:text-slate-400"
        }`}
      >
        {ep}
      </div>
