...
const STATUS_LABEL: Partial<Record<JobStatus, string>> = {
  ...
  transcribing_lyrics:  "歌詞を確認しています",
  merging_lyrics:       "歌詞のずれを補正しています",
  quality_checking:     "歌詞と反復を検査しています",
  regenerating_audio:   "品質を改善するため再生成しています",
  review_required:      "歌詞の最終確認が必要です",
  completed:            "完成しました",
  failed:               "生成に失敗しました",
